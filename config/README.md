# Config [![GoDoc](https://godoc.org/git.aimap.io/go/config/config?status.svg)](https://godoc.org/git.aimap.io/go/config/config)
...
For detailed information or architecture, installation and general usage see the [docs](https://micro.mu/docs/config.html)
