...
import (
	...
	"github.com/chendeke/config/client"
	cgrpc "github.com/chendeke/config/client/grpc"
	cmucp "github.com/chendeke/config/client/mucp"
	"github.com/chendeke/config/server"
	sgrpc "github.com/chendeke/config/server/grpc"
	smucp "github.com/chendeke/config/server/mucp"
	"github.com/chendeke/config/util/log"

	// brokers
	"github.com/chendeke/config/broker"
	"github.com/chendeke/config/broker/http"
	"github.com/chendeke/config/broker/memory"
	"github.com/chendeke/config/broker/nats"

	// registries
	"github.com/chendeke/config/registry"
	"github.com/chendeke/config/registry/consul"
	"github.com/chendeke/config/registry/gossip"
	"github.com/chendeke/config/registry/mdns"
	rmem "github.com/chendeke/config/registry/memory"

	// selectors
	"github.com/chendeke/config/client/selector"
	"github.com/chendeke/config/client/selector/dns"
	"github.com/chendeke/config/client/selector/router"
	"github.com/chendeke/config/client/selector/static"

	// transports
	"github.com/chendeke/config/transport"
	tgrpc "github.com/chendeke/config/transport/grpc"
	thttp "github.com/chendeke/config/transport/http"
	tmem "github.com/chendeke/config/transport/memory"
)
